    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-[#111827] border border-gray-800 rounded-xl p-8">
        ...
        <button
          ...
          className="w-full bg-white hover:bg-gray-100 text-gray-800 font-medium py-3 rounded-lg flex items-center justify-center gap-3 transition-colors"
        >
        ...
        <button
          onClick={() => router.push('/')}
          className="w-full mt-4 border border-gray-700 hover:border-gray-500 text-gray-400 py-3 rounded-lg transition-colors text-sm"
        >
