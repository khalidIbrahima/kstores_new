      ...
      <div className="flex items-center gap-2">
        {shareLinks.map((link) => (
          <a
            ...
            className={`w-9 h-9 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white transition-all ${link.color}`}
          >
            {link.icon}
          </a>
        ))}
